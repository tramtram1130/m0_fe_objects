...
var email = {
  ...
  attachments: 4,
  message: '"These are some good choices for dinner tonight. I have attached the menus below."',
  additionalReceivers: ['Cassie', 'Marcial', 'Stasha']
}
...
emails = [
  ...
  },
  {
    ...
    attachment: 1,
    message: '"I sent you a Venmo request!"',
    additionalReceivers: []
  },
  {
    sender: 'Prince of Nigeria',
    subject: 'Oppurtunities to make MILLIONS!',
    attachment: 2,
    message: '"I am in need of assistance and will greatly repay you! Please go to the link below."',
    additionalReceivers: ['random1', 'random2', 'random3', 'random4', 'random5']
  }
];
